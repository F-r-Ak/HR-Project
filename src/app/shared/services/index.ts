...
export * from './enums/government/government.service';  
export * from './enums/maritalStatus/maritalStatus.service';
export * from './enums/militaryStatus/militaryStatus.service';
export * from './enums/religion/religion.service';
export * from './enums/familyRelationship/familyRelationship.service';