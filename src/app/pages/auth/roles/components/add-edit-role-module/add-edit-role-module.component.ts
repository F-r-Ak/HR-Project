...
import { SubmitButtonsComponent, PrimeAutoCompleteComponent, AssignmentOrgsService, OrganizationsService, EmployeeService, PrimeInputTextComponent, PagesService } from '../../../../../shared';
...
@Component({
    ...
    styleUrl: './add-edit-role-module.component.scss'
})
export class AddEditRoleModuleComponent extends BaseEditComponent implements OnInit {
